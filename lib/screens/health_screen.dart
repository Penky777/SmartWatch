...
class _HealthScreenState extends State<HealthScreen> {
  ...
  void initState() {
    ...
    // ✅ Počúvaj status pre connection banner
  ...
  // ✅ Konvertuj históriu na FlSpot pre graf
  ...
  // ✅ Vypočítaj progress pre trend bar (0.0 - 1.0)
  ...
  Widget build(BuildContext context) {
    ...
    // ✅ Použij dáta z repo (prežijú navigáciu)
    ...
    return ScreenScaffold(
      ...
      actions: [
        IconButton(
          onPressed: () {
            // TODO: Manuálny refresh - poslať request na hodinky
          },
          icon: const Icon(Icons.refresh),
        ),
      ],
      child: ListView(
        padding: const EdgeInsets.only(bottom: 24), // ✅ FIX pre scroll
        children: [
